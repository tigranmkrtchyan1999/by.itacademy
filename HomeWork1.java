...
//        int b = a / 3;
//        if (b == 9) {
//            System.out.print("последняя цифра числа семерка");
//        } else {
//            System.out.print("последняя цифра числа не является семеркой");
//        }
//    }
//}
...
//            System.out.print("отверстие полностью закроет круглой картонкой");
//        } else {
//            System.out.print("отверстие не закроет круглой картонкой");
//        }
//    }
// }
